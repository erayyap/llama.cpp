...
const ggml_tensor * llama_model_dspark_markov_w1(const struct llama_model * model) {
    return model->dspark_markov_w1;
}

const ggml_tensor * llama_model_dspark_markov_w2(const struct llama_model * model) {
    return model->dspark_markov_w2;
}
